...
class ProductController extends Controller
{
    ...
    private $products = [['id' => 1, 'name' => 'Essentials Hoodie Black',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in black. Made with high-quality fabric, it offers a relaxed fit and features a minimalist design with the "Essentials".',
            'price' => 7000,
        ...
        ['id' => 2, 'name' => 'Essentials Hoodie Light Oatmeal',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in Light Oatmeal.',
            'price' => 9000,
        ...
        ['id' => 3, 'name' => 'Essentials Hoodie Dark Oatmeal',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in Dark Oatmeal.',
            'price' => 5990,
        ...
        ['id' => 4, 'name' => 'Essential Hoodie Gray',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in Gray.',
            'price' => 2380,
        ...
        ['id' => 5, 'name' => 'Essential Hoodie Brown',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in Brown.',
            'price' => 3000,
            'imageSRC' => 'https://cdn-images.farfetch-contents.com/27/49/82/78/27498278_57262612_1000.jpg'],
        ['id' => 6, 'name' => 'Essential Hoodie White',
            'description' => 'This is a stylish and comfortable Essentials Hoodie in White.',
            'price' => 2900,
            'imageSRC' => 'https://i.ebayimg.com/images/g/ZzsAAOSw4KBnI1zn/s-l1600.webp'],
        ['id' => 7, 'name' => 'BASIC STÜSSY HOODIE BLACK',
            'description' => 'The Basic Stüssy Hoodie Black is a classic streetwear essential. This hoodie features a bold Stüssy logo on the back.',
            'price' => 3100,
        ...
        ['id' => 8, 'name' => 'DICED OUT HOODIE White',
            'description' => 'The Diced Out Hoodie White from Stüssy is a unique and stylish addition to any casual wardrobe.',
            'price' => 3100,
        ...
        ['id' => 9, 'name' => 'Logo Velvet Relaxed Fit Ls Polo Shirt',
            'description' => 'This Logo Velvet Relaxed Fit Long Sleeve Polo Shirt is the epitome of luxury streetwear.',
            'price' => 8300,
        ...
        ['id' => 10, 'name' => 'A Rising BAPE Military Shark Full Zip Hoodie',
            'description' => 'The A Rising BAPE Military Shark Full Zip Hoodie is a bold and iconic piece that combines functionality and standout design.',
            'price' => 26000,
